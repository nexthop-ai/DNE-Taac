...
This file is scheduled for removal as part of an ongoing migration from Thrift-py to Thrift-python. It has been
duplicated with modifications (all unspecified fields marked as optional) in bgp_config_v2.thrift, which will replace
these once the migration is complete. (TODO: T223652622)
-------------------------------------------------------- */
...
include "configerator/fboss/bgp/bgp_attr.thrift"
