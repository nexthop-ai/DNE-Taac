...
test_config = taac_thrift.TestConfig(
    ...
    endpoints=[
        taac_thrift.Endpoint(
            name="rsw001.p003.f01.qzd1", dut=True, ixia_ports=["eth1/16/1"]
        ),
        taac_thrift.Endpoint(name="rsw002.p003.f01.qzd1", ixia_ports=["eth1/10/1"]),
        taac_thrift.Endpoint(
            name="fsw001.p003.f01.qzd1",
            dut=True,
        ),
        taac_thrift.Endpoint(
            name="fsw002.p003.f01.qzd1",
        ),
    ],
    postchecks=[
        ...
        taac_thrift.BasicTrafficItemConfig(
            ...
            src_endpoints=[
                taac_thrift.TrafficEndpoint(
                    name="rsw001.p003.f01.qzd1:eth1/16/1",
            ...
            dest_endpoints=[
                taac_thrift.TrafficEndpoint(
                    name="rsw002.p003.f01.qzd1:eth1/10/1",
                    device_group_index=0,
                    network_group_index=0,
                )
            ],
    ...
    basic_port_configs=[
        taac_thrift.BasicPortConfig(
            ...
            endpoint="rsw001.p003.f01.qzd1:eth1/16/1",
        ),
        taac_thrift.BasicPortConfig(
            device_group_configs=[
                taac_thrift.DeviceGroupConfig(
            ...
            endpoint="rsw002.p003.f01.qzd1:eth1/10/1",
        ),
    ],
    playbooks=[
        taac_thrift.Playbook(
            name="test_bgpd_restart",
            device_regexes=["rsw001.p003.f01.qzd1"],
            stages=[
                taac_thrift.Stage(
                    steps=[
                        taac_thrift.Step(
        ...
        taac_thrift.Playbook(
            ...
            device_regexes=["fsw001.p003.f01.qzd1"],
            stages=[
                taac_thrift.Stage(
                    steps=[
                        taac_thrift.Step(
                ...
                taac_thrift.Stage(
                    steps=[
                        ...
                        taac_thrift.Step(
                            name=taac_thrift.StepName.SERVICE_CONVERGENCE_STEP,
                            input_json=thrift_to_json(
                                taac_thrift.ServiceConvergenceInput(timeout=600)
                            ),
                        ),
                    ]
                )
