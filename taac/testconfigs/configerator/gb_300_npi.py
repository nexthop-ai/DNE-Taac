...
test_config = taac_thrift.TestConfig(
    ...
    endpoints=[
        taac_thrift.Endpoint(
            name="rsw001.p001.m001.qzr1", dut=True, ixia_ports=["eth1/64/5"]
        ),
        taac_thrift.Endpoint(
            name="rsw002.p001.m001.qzr1",
            ixia_ports=["eth1/17/1"],
        ),
        taac_thrift.Endpoint(
            name="fsw001.p001.m001.qzr1",
            dut=True,
        ),
        taac_thrift.Endpoint(
            name="fsw002.p001.m001.qzr1",
            dut=True,
        ),
        taac_thrift.Endpoint(
            name="fsw003.p001.m001.qzr1",
        ),
        taac_thrift.Endpoint(
            name="fsw004.p001.m001.qzr1",
        ),
    ],
    postchecks=[
    ...
    basic_traffic_item_configs=[
        taac_thrift.BasicTrafficItemConfig(
            ...
            dest_endpoints=[
                taac_thrift.TrafficEndpoint(
                    name="rsw002.p001.m001.qzr1:eth1/17/1",
                    device_group_index=0,
                    network_group_index=0,
                )
            ],
    ...
    basic_port_configs=[
        ...
        taac_thrift.BasicPortConfig(
            ...
            endpoint="rsw002.p001.m001.qzr1:eth1/17/1",
        ),
    ],
    playbooks=[
        taac_thrift.Playbook(
            name="test_bgpd_restart",
            device_regexes=["rsw001.p001.m001.qzr1"],
            stages=[
                taac_thrift.Stage(
                    steps=[
                        taac_thrift.Step(
        ...
        taac_thrift.Playbook(
            ...
            device_regexes=["fsw001.p001.m001.qzr1"],
            stages=[
                taac_thrift.Stage(
                    steps=[
                        taac_thrift.Step(
